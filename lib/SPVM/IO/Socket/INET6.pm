...
SPVM::IO::Socket::INET6 - IPv6 Socket
...
C<IO::Socket::INET6> provides IPv4 Socket.
...
=head2 Perl's IO::Socket::INET6

C<IO::Socket::INET6> is a Perl's L<IO::Socket::INET6|IO::Socket::INET6> porting to L<SPVM>.
